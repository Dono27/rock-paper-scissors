...
#images
rockImage = PhotoImage(file = "nrehtron/rps/rock.gif")
paperImage = PhotoImage(file = "nrehtron/rps/paper.gif")
scissorsImage = PhotoImage(file = "nrehtron/rps/scissors.gif")
